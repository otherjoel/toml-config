...
(check-equal?
 (map second (lex-string "dotted.\"quoted\".'mixed' = \"value\""))
 '(symbol other symbol other symbol white-space other white-space string))
  
;; Dotted key with bare and quoted parts
(check-equal?
 (map second (lex-string "bare.\"with spaces\".more = \"value\""))
 '(symbol other symbol other symbol white-space other white-space string))
